...
class MapState extends FlxState {
	...
	override public function create():Void {
		...
		if (Globals.level1State == 0){
			_level1button = new MapButton(348, 73, "assets/images/level1outline.png" , "PlayState");
		...
		if (Globals.level2State == 0){
			_level2button = new MapButton(156, 94, "assets/images/level2outline.png" , "PlayState");
		...
		if (Globals.level3State == 0){
			_level3button = new MapButton(175, 292, "assets/images/level3outline.png" , "PlayState");
		...
		if (Globals.level4State == 0){
			_level4button = new MapButton(352, 452, "assets/images/level4outline.png" , "PlayState");
		...
		if (Globals.level5State == 0){
			_level5button = new MapButton(561, 424, "assets/images/level5outline.png" , "PlayState");
